aphrodite = {
    ...
    "relatives": {
      "father":"Zeus",
      "spouses": "Hephaestus",
      "lovers": ["Ares", "Poseidon"],
      "siblings": ["Apollo", "Ares", "Artemis", "Athena", "Dionysus","Hephaestus", "Hermes"]
    },
  },
apollo = {
    "name":"Apollo",
    ...
    "relatives": {
      "father":"Zeus",
      "siblings": ["Artemis", "Aphrodite", "Ares", "Athena", "Dionysus", "Hephaestus", "Hermes"]
    },
  },
ares = {
    "name":"Ares",
    ...
    "relatives": {
      ...
      "mother":"Hera",
      "lovers": "Aphrodite",
      "siblings": ["Aphrodite", "Apollo", "Artemis", "Athena", "Dionysus", "Hermes"]
    },
  },
artemis = {
    "name":"Artemis",
    ...
    "relatives": {
      "father":"Zeus",
      "siblings": ["Apollo", "Aphrodite", "Ares", "Athena", "Dionysus", "Hephaestus","Hermes"]
    },
  },
athena = {
    "name":"Athena",
    ...
    "relatives": {
      "father":"Zeus",
      "siblings":["Aphrodite", "Apollo", "Ares", "Artemis", "Dionysus","Hermes"]
    },
  },
demeter = {
    "name":"Demeter",
    ...
    "gender":"female",
    "relatives": {
      "Siblings":["Zeus", "Hera", "Hades", "Poseidon","Hestia"],
    },
  },
dionysus = {
    ...
    "relatives": {
      "father":"Zeus",
      "siblings":["Aphrodite", "Apollo", "Ares", "Artemis", "Athena","Hermes"]
    },
  },
hades = {
    "name":"Hades/Pluto",
    ...
    "gender":"Male",
    "relatives": {
      "siblings": ["Poseidon", "Demeter", "Herea", "Zeus","Hestia"]
    },
  },
hephaestus = {
    "name":"Hephaestus",
    ...
    "relatives": {
      ...
      "mother":"Hera",
      "spouses": "Aphrodite",
      "siblings": ["Aphrodite", "Apollo", "Ares", "Artemis","Athena","Dionysus","Hermes"]
    },
  },
hera = {
    "name":"Hera",
...
heremes = {
    ...
    "relatives": {
      "father":"Zeus",
      "siblings": ["Aphrodite", "Apollo", "Ares", "Artemis", "Athena", "Dionysus", "Hephaestus"]
    },
  },
hestia = {
    "name":"Hestia",
...
poseidon = {
    ...
    "relatives": {
      "lovers": "Aphrodite",
      "siblings": ["Demeter", "Hera", "Hades", "Hestia","Zeus"]
    },
  },
zeus = {
    "name":"Zeus",
    ...
    "relatives": {
      "spouses": "Hera",
      "lovers": "Hera",
      "children": ["Aphrodite", "Apollo", "Ares", "Artemis", "Athena", "Dionysus", "Hephaestus", "Hermes"],
      "siblings": ["Demeter", "Hera", "Hades", "Hestia","Poseidon"]
    },
},
Olympians = {
    'Poseidon' : poseidon,
...
def calypso(durin):
       if durin == "Zeus":
           return(Olympians['Zeus'])
       if durin == "Poseidon":
          return(Olympians['Poseidon']) 
       if durin == "Hestia":
          return(Olympians['Hestia'])
       if durin == "Hermes":
           return(Olympians['Hermes'])
       if durin == "Hera":
            return(Olympians['Hera'])
       if durin == "Hephaestus":
            return(Olympians['Hephaestus'])
       if durin == "Hades":
            return(Olympians['Hades'])
       if durin == "Dionysus":
            return(Olympians['Dionysus'])
       if durin == "Demeter":
            return(Olympians['Demeter'])
       if durin == "Athena":
            return(Olympians['Athena'])
       if durin == "Artemis":
            return(Olympians['Artemis'])
       if durin == "Ares":
            return(Olympians['Ares'])
       if durin == "Apollo":
            return(Olympians['Apollo'])
       if durin == "Aphrodite":
            return(Olympians['Aphrodite'])


while True:
  print("Name an Olympian, mortal...")
  Ajax = input()
  gandalf = calypso(Ajax)
  if Ajax == 'Poseidon' or 'Zeus'or 'Hades'or 'Aphrodite'or 'Apollo'or 'Ares'or 'Artemis'or 'Athena'or 'Demeter'or 'Dionysus' or 'Hephaestus'or 'Hera' or 'Heremes'or 'Hestia':     
    print(gandalf)
