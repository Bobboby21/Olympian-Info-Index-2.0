...
Ajax = input("Name one of the three Major Olympians, mortal...")
print("Here you go:", The_Big_Three[Ajax])
Fenris = input("Name a relative to know more, or type return to return to the beginning...")

def Brutus(Calypso,Durin):
    return(Calypso[Durin])

Euripides = Brutus(Ajax,Fenris)
print(Euripides)